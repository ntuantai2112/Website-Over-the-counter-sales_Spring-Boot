...
<div class="container">
    ...
    <div class="row">
        ...
        <c:if test="${not empty errBillNull}">
            <div class="alert alert-warning">
                <strong> ${errBillNull}</strong>
            </div>
        </c:if>

        <c:if test="${not empty errorMessageBill}">
            <div class="alert alert-warning">
                <strong> ${errorMessageBill}</strong>
            </div>
        </c:if>

        <c:if test="${not empty errorMessageMoney}">
            <div class="alert alert-warning">
                <strong> ${errorMessageMoney}</strong>
            </div>
        </c:if>
        ...
        <c:if test="${not empty errCountQuantityMess}">
            <div class="alert alert-warning">
                <strong> ${errCountQuantityMess}</strong>
            </div>
        </c:if>
        ...
        <div class="col-8">
                                ...
                                <td>
                                    <ul class="list-inline pb-3">
                                        ...
                                        <li class="list-inline-item"><span class="badge bg-secondary"
                                                                           id="var-value">${hoaDonChiTiet.soLuong}</span>
                                        </li>
                                        <li class="list-inline-item">
            ...
            <c:if test="${not empty errMessageQuantity}">
                <div class="alert alert-danger">
                    <strong>Lỗi!</strong> ${errMessageQuantity}
                </div>
            </c:if>
                        ...
                        <c:forEach items="${pageSanPhamChiTiet.content}" varStatus="sanPham" var="sp">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/ban-hang/gio-hang/add-to-cart/${sp.id}">
                                        <button type="button" class="btn btn-primary"
                                                onclick="return validateBeforeAddToCart()">Add To Cart
                                        </button>
                                    </a>
                                </td>
                            </tr>
                            ...
                            <ul class="pagination">
                                <li class="page-item">
                                    <c:if test="${pageSanPhamChiTiet.number > 0}">
                                        <a class="page-link"
                                           href="/ban-hang/sell?page=${pageSanPhamChiTiet.number - 1}">Previous</a>
                                    </c:if>
                                </li>
                                ...
                                <li class="page-item">
                                    <c:if test="${pageSanPhamChiTiet.number + 1 < pageSanPhamChiTiet.totalPages}">
                                        <a class="page-link"
                                           href="/ban-hang/sell?page=${pageSanPhamChiTiet.number + 1}">Next</a>
                                    </c:if>
                                </li>
                            </ul>
                        </nav>
                ...
                <div class="card-body">
                    ...
                    <sf:form method="POST" action="/ban-hang/thanh-toan/${data.id}" modelAttribute="data"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input id="tongTien" name="tongTien" type="text" class="form-control"
...
<%--                            <div class="col-sm-6">--%>
<%--                                <input id="tienKhachDua" name="tienKhachDua" class="form-control" type="number" required>--%>
<%--                            </div>--%>
...
<%--                            <div class="col-sm-8">--%>
<%--                                <input id="tienTraLai" name="tienTraLai" value="${tienTraLai}" disabled type="number" class="form-control" required>--%>
<%--                            </div>--%>
<%--                        </div>--%>
...
<%--                            <div class="col-sm-4">--%>
<%--                                <a href="/ban-hang/tinh-tien/${data.id}">--%>
<%--                                    <button  class="btn btn-success ">Tính Tiền</button>--%>
<%--                                </a>--%>
<%--                            </div>--%>
                        </div>
                    </sf:form>
