...
<div>
    ...
    <div class="container">
        <sf:form action="/san-pham/edit-product/${product.id}" method="post" modelAttribute="product">
            <div class="mb-3">
                <label class="form-label">ID Product</label>
                <sf:input path="id" disabled="true" type="text" name="id" placeholder="Id Product" class="form-control"
            ...
            <div class="mb-3">
                ...
                <sf:input path="ma" type="text" name="ma" placeholder="Ma Product" class="form-control"
                          aria-describedby="emailHelp"/>
            ...
            <div class="mb-3">
                ...
                <sf:input path="ten" type="text" name="ten" placeholder="Name Product" class="form-control"
                          aria-describedby="emailHelp"/>
            ...
            <div class="mb-3">
                ...
                <sf:input path="trangThai" type="text" name="ten" placeholder="Name Product" class="form-control"
                          aria-describedby="emailHelp"/>
