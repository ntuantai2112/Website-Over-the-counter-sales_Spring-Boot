...
<div class="container">
    ...
    <div class="float-end">
        <a href="/san-pham/create-product">
    ...
    <table class="table mt-5">
        ...
        <c:forEach items="${pageSanPham.content}" varStatus="sanPhamDTO" var="sp">
            <tr>
                <th scope="row">${sanPhamDTO.index+1}</th>
                <td>${sp.id}</td>
                <td>${sp.ma}</td>
                <td>${sp.ten}</td>
                <td>${sp.trangThai == 0 ? "Inactive" : "Active"}</td>
                <div class="float-end">
                    <td>
                        <a href="/san-pham/edit-product/${sp.id}">
                            <button type="button" class="btn btn-success">Edit</button>
                        </a>
                        <a href="/san-pham/delete-product/${sp.id}">
                        ...
                        <a href="/san-pham/product/${sp.id}">
                            <button type="button" class="btn btn-warning">Detail</button>
                        </a>

                        <a href="/gio-hang/add-to-cart/${sp.id}">
                ...
                <ul class="pagination">
                    <li class="page-item">
                        <c:if test="${pageSanPham.number > 0}">
                            <a class="page-link" href="/san-pham/show-product?page=${pageSanPham.number - 1}">Previous</a>
                        </c:if>
                    </li>
                    <li class="page-item"><a class="page-link disabled active-page" onclick="return false;"   href="#">${pageSanPham.number + 1}</a></li>
                    <li class="page-item">
                        <c:if test="${pageSanPham.number + 1 < pageSanPham.totalPages}">
                            <a class="page-link" href="/san-pham/show-product?page=${pageSanPham.number + 1}">Next</a>
                        </c:if>
                    </li>
                </ul>
            </nav>
