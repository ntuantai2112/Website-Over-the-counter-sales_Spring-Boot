...
<%--        body--%>
        <h1 class="text-center">Create BillDetail</h1>
<div>

   <div class="container">
       <sf:form action="/hoa-don-chi-tiet/create-billDetail" method="post" modelAttribute="billDetail">
           ...
           <div class="mb-3">
               ...
               <sf:input path="soLuong" type="text" name="" placeholder="Status Product" class="form-control"  aria-describedby="emailHelp"/>
           ...
           <div class="mb-3">
               ...
               <sf:input path="donGia" type="text" name="" placeholder="Unit Price Product" class="form-control"  aria-describedby="emailHelp"/>
           ...
           <div class="mb-3">
               ...
               <sf:input path="thoiGian" type="date" name="" placeholder="Status Product" class="form-control"  aria-describedby="emailHelp"/>
