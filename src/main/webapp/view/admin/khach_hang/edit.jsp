...
<div>
    ...
    <div class="container">
        <sf:form action="/khach-hang/edit-customer/${customer.id}" method="post" modelAttribute="customer">
            <div class="mb-3">
                <label  class="form-label">ID Khách Hàng</label>
                <sf:input path="id" disabled="true" type="text" name="id" placeholder="Id Customer" class="form-control"  aria-describedby="emailHelp" />
                <sf:errors path="id" cssStyle="color: red"></sf:errors>
            </div>

            <div class="mb-3">
                <label  class="form-label">Mã Khách Hàng </label>
                <sf:input path="ma" type="text"   placeholder="Ma Customer" class="form-control"  aria-describedby="emailHelp" />
                <sf:errors path="ma" cssStyle="color: red"></sf:errors>
            </div>

            <div class="mb-3">
                <label  class="form-label">Tên Khách Hàng</label>
                <sf:input path="ten" type="text" name="ten" placeholder="Name Customer" class="form-control"  aria-describedby="emailHelp"/>
                <sf:errors path="ten" cssStyle="color: red"></sf:errors>
            </div>

            <div class="mb-3">
                <label  class="form-label">Số Điện Thoại </label>
                <sf:input path="sdt" type="text"   placeholder="Ma Customer" class="form-control"  aria-describedby="emailHelp" />
                <sf:errors path="sdt" cssStyle="color: red"></sf:errors>
            </div>

            <div class="mb-3">
                <label class="form-label">Trạng Thái</label>
                <sf:input path="trangThai" type="text"   placeholder="Ma Customer" class="form-control"  aria-describedby="emailHelp" />
