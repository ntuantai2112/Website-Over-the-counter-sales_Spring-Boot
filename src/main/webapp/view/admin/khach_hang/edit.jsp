    ...
    <div class="container">
        <sf:form action="/khach-hang/edit-customer/${customer.id}" method="post" modelAttribute="customer">
            <div class="mb-3">
                ...
                <sf:input path="id" disabled="true" type="text" name="id" placeholder="Id Customer" class="form-control"
            ...
            <div class="mb-3">
                ...
                <sf:input path="ma" type="text" placeholder="Ma Customer" class="form-control"
                          aria-describedby="emailHelp"/>
            ...
            <div class="mb-3">
                ...
                <sf:input path="ten" type="text" name="ten" placeholder="Name Customer" class="form-control"
                          aria-describedby="emailHelp"/>
            ...
            <div class="mb-3">
                ...
                <sf:input path="sdt" type="text" placeholder="Ma Customer" class="form-control"
                          aria-describedby="emailHelp"/>
            ...
            <div class="mb-3">
                ...
                <sf:input path="trangThai" type="text" placeholder="Ma Customer" class="form-control"
                          aria-describedby="emailHelp"/>
