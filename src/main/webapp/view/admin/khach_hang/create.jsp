    ...
    <div class="container">
        <sf:form action="/khach-hang/create-customer" method="post" modelAttribute="customer">
            ...
            <div class="mb-3">
                ...
                <sf:input path="sdt" type="text" placeholder="SDT Customer" class="form-control"
                          aria-describedby="emailHelp"/>
            ...
            <div class="mb-3">
                ...
                <sf:input path="trangThai" type="text" placeholder="Status Customer" class="form-control"
                          aria-describedby="emailHelp"/>
