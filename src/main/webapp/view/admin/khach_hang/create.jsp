...
<div>
   ...
   <div class="container">
       <sf:form action="/khach-hang/create-customer" method="post" modelAttribute="customer">
           ...
           <div class="mb-3">
               ...
               <sf:input path="sdt" type="text"   placeholder="SDT Customer" class="form-control"  aria-describedby="emailHelp" />
               <sf:errors path="sdt" cssStyle="color: red"></sf:errors>
           </div>

           <div class="mb-3">
               <label class="form-label">Trạng Thái</label>
               <sf:input path="trangThai" type="text"   placeholder="Status Customer" class="form-control"  aria-describedby="emailHelp" />
