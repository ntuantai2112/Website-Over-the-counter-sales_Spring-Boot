...
<div>
    ...
    <div class="container">
        <sf:form action="/hoa-don/update-bill/${bill.id}" method="post" modelAttribute="bill">

            <div class="mb-3">
                <label  class="form-label">Id Hóa Đơn</label>
                <sf:input path="id" disabled="true" type="text" name="id" placeholder="Status Product" class="form-control"  aria-describedby="emailHelp"/>
