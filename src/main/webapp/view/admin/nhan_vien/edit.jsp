...
<div>
    ...
    <div class="container">
        <sf:form action="/nhan-vien/edit-employee/${employee.id}" method="post" modelAttribute="employee">
            <div class="mb-3">
                <label  class="form-label">ID Employee</label>
                <sf:input path="id" disabled="true"  type="text" name="id" placeholder="Id Employee" class="form-control"  aria-describedby="emailHelp" />
                <sf:errors path="id" cssStyle="color: red"></sf:errors>
            </div>

            <div class="mb-3">
                <label  class="form-label">Mã Nhân Viên </label>
                <sf:input path="ma" type="text"   placeholder="Ma Employee" class="form-control"  aria-describedby="emailHelp" />
                <sf:errors path="ma" cssStyle="color: red"></sf:errors>
            </div>

            <div class="mb-3">
                <label  class="form-label">Tên Nhân Viên </label>
                <sf:input path="ten" type="text" name="ten" placeholder="Name Employee" class="form-control"  aria-describedby="emailHelp"/>
            ...
            <div class="mb-3">
                ...
                <sf:input path="tenDangNhap" type="text"  placeholder="Name Employee" class="form-control"  aria-describedby="emailHelp"/>
            ...
            <div class="mb-3">
                ...
                <sf:input path="matKhau" type="password"  placeholder="Name Employee" class="form-control"  aria-describedby="emailHelp"/>
                <sf:errors path="matKhau" cssStyle="color: red"></sf:errors>

            </div>
            <div class="mb-3">
                <label class="form-label">Trạng Thái</label>
                <sf:input path="trangThai" type="text"  placeholder="Name Employee" class="form-control"  aria-describedby="emailHelp"/>
