...
<div>
   ...
   <div class="container">
       <sf:form action="/nhan-vien/create-employee" method="post" modelAttribute="employee">
           ...
           <div class="mb-3">
               ...
               <sf:input path="trangThai" type="password"  placeholder="Name Employee" class="form-control"  aria-describedby="emailHelp"/>
