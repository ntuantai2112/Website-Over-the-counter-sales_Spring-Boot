...
<div>
   ...
   <div class="container">
       <sf:form action="/mau-sac/create-color" method="post" modelAttribute="data">
...
<%--           </div>--%>
           ...
           <div class="mb-3">
               ...
               <sf:input path="trangThai" type="text" name="ten" placeholder="Status Color" class="form-control"  aria-describedby="emailHelp"/>
