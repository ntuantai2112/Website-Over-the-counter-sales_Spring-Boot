    ...
    <div class="container">
        <sf:form action="/mau-sac/create-color" method="post" modelAttribute="data">
            ...
            <div class="mb-3">
                ...
                <sf:input path="ma" type="text" name="ma" placeholder="Ma Color" class="form-control"
            ...
            <div class="mb-3">
                ...
                <sf:input path="ten" type="text" name="ten" placeholder="Name Color" class="form-control"
                          aria-describedby="emailHelp"/>
            ...
            <div class="mb-3">
                ...
                <sf:input path="trangThai" type="text" name="ten" placeholder="Status Color" class="form-control"
                          aria-describedby="emailHelp"/>
