...
<div>
    ...
    <div class="container">
        <sf:form action="/mau-sac/edit-color/${mauSac.id}" method="post" modelAttribute="mauSac">
            <div class="mb-3">
                <label  class="form-label">ID Color</label>
                <sf:input path="id" disabled="true" type="text" name="id" placeholder="Id Color" class="form-control"  aria-describedby="emailHelp" />
                <sf:errors path="id" cssStyle="color: red"></sf:errors>
            </div>

            <div class="mb-3">
                <label  class="form-label">Mã màu sắc </label>
                <sf:input path="ma" type="text"  name="ma" placeholder="Ma Color" class="form-control"  aria-describedby="emailHelp" />
                <sf:errors path="ma" cssStyle="color: red"></sf:errors>
            </div>

            <div class="mb-3">
                <label  class="form-label">Tên màu sắc </label>
                <sf:input path="ten" type="text" name="ten" placeholder="Name Color" class="form-control"  aria-describedby="emailHelp"/>
            ...
            <div class="mb-3">
                ...
                <sf:input path="trangThai" type="text" placeholder="Status Color" class="form-control"  aria-describedby="emailHelp"/>
