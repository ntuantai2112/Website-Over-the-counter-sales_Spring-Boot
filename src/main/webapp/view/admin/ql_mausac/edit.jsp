    ...
    <div class="container">
        <sf:form action="/mau-sac/edit-color/${mauSac.id}" method="post" modelAttribute="mauSac">
            <div class="mb-3">
                ...
                <sf:input path="id" disabled="true" type="text" name="id" placeholder="Id Color" class="form-control"
            ...
            <div class="mb-3">
                ...
                <sf:input path="trangThai" type="text" placeholder="Status Color" class="form-control"
                          aria-describedby="emailHelp"/>
