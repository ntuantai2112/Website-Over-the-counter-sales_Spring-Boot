...
<div>
    ...
    <div class="container">
        <sf:form action="/san-pham/create-product" method="post" modelAttribute="product">
            <div class="mb-3">
                <label class="form-label">ID Product</label>
                <sf:input path="id" type="text" name="id" placeholder="Id Product" class="form-control"
            ...
            <div class="mb-3">
                <label class="form-label">Tên Sản Phảm </label>
