...
<div>
   ...
   <div class="container">
       <sf:form action="/kich-thuoc/create-size" method="post" modelAttribute="size">


           <div class="mb-3">
               <label  class="form-label">Mã Kích Thước </label>
               <sf:input path="ma" type="text"  placeholder="Ma Color" class="form-control"  aria-describedby="emailHelp" />
               <sf:errors path="ma" cssStyle="color: red"></sf:errors>
           </div>

           <div class="mb-3">
               <label  class="form-label">Tên Kích Thước </label>
               <sf:input path="ten" type="text"  placeholder="Name Color" class="form-control"  aria-describedby="emailHelp"/>
