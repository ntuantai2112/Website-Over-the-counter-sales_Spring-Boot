    ...
    <div class="container">
        <sf:form action="/kich-thuoc/edit-size/${size.id}" method="post" modelAttribute="size">
            <div class="mb-3">
                ...
                <sf:input path="id" disabled="true" type="text" name="id" placeholder="Id Size" class="form-control"
            ...
            <div class="mb-3">
                ...
                <sf:input path="ma" type="text" name="ma" placeholder="Ma Size" class="form-control"
                          aria-describedby="emailHelp"/>
            ...
            <div class="mb-3">
                ...
                <sf:input path="ten" type="text" name="ten" placeholder="Name Size" class="form-control"
                          aria-describedby="emailHelp"/>
            ...
            <div class="mb-3">
                ...
                <sf:input path="trangThai" type="text" name="ten" placeholder="Name Size" class="form-control"
                          aria-describedby="emailHelp"/>
