...
<div>
    ...
    <div class="container">
        <sf:form action="/kich-thuoc/edit-size/${size.id}" method="post" modelAttribute="size">
            <div class="mb-3">
                <label  class="form-label">ID Color</label>
                <sf:input path="id" disabled="true" type="text" name="id" placeholder="Id Size" class="form-control"  aria-describedby="emailHelp" />
                <sf:errors path="id" cssStyle="color:red"></sf:errors>
            </div>

            <div class="mb-3">
                <label  class="form-label">Ma </label>
                <sf:input path="ma" type="text"  name="ma" placeholder="Ma Size" class="form-control"  aria-describedby="emailHelp" />
                <sf:errors path="ma" cssStyle="color:red"></sf:errors>
            </div>

            <div class="mb-3">
                <label  class="form-label">Tên </label>
                <sf:input path="ten" type="text" name="ten" placeholder="Name Size" class="form-control"  aria-describedby="emailHelp"/>
            ...
            <div class="mb-3">
                ...
                <sf:input path="trangThai" type="text" name="ten" placeholder="Name Size" class="form-control"  aria-describedby="emailHelp"/>
