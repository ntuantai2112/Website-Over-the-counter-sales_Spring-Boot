...
<div class="container">
    ...
    <table class="table mt-5">
        ...
        <c:forEach items="${pageKichThuoc.content}" varStatus="size" var="kt">
            <tr>
                <th scope="row">${size.index+1}</th>
                <td>${kt.id}</td>
                <td>${kt.ma}</td>
                <td>${kt.ten}</td>
                <td>${kt.trangThai == 0 ? "Inactive" : "Active"} </td>
                <div class="float-end">
                    <td>
                        <a href="/kich-thuoc/edit-size/${kt.id}">
